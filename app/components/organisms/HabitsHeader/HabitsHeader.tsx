...
import { StyledWrapper, StyledContent, StyledCalendarItem, StyledBar, StyledDot } from './styles';
        ...
        <StyledContent>
          ...
          <FlatList
            ...
            renderItem={({ item, index }) => {
              ...
              return (
                <StyledCalendarItem key={day} onPress={() => selectDay(index)} activeOpacity={1}>
                  <Typography
                    color={selectedDate.getDate() - 1 == index ? 'primary' : 'secondary'}
                    isCentered
                  >
                    {name}
                  </Typography>
